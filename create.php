...
if (isset($_POST['submit'])) {
    ...
    $ins = "INSERT INTO post (title, author, description, content, image_url) VALUES (?, ?, ?, ?, ?)";
    $st = mysqli_prepare($conn, $ins);

    if ($st) {
        // Bind the parameters to the prepared statement
        mysqli_stmt_bind_param($st, "sssss", $title, $author, $description, $content, $image);
...
<body>
    <!-- This nav is for the back button -->
    <nav>
        <div>
        </div>
    ...
    <div class="container">
        ...
        <!-- This form where you input your blog post -->
        <form action="create.php" method="POST" data-aos="zoom-out" data-aos-duration="3500">
            <h1>Post a Blog</h1>
            <div class="card">
                <label for="title">Title</label>
                <input type="text" name="title" required id="title" placeholder="Enter Title">
            </div>
            <div class="card">
                <label for="author">Author</label>
                <input type="text" name="author" required id="author" placeholder="Enter Author">
            </div>
            <div class="card">
                <label for="description">Description</label>
                <input type="text" name="description" required id="description" placeholder="Enter Description">
            </div>
            <div class="card">
                <label for="content">Content</label>
                <input type="text" name="content" required id="content" placeholder="Enter Content">
            </div>
            <div class="card">
                <label for="image">Image Url</label>
                <input type="text" name="image" required id="image" placeholder="Enter Image Url">
            </div>
            <button type="submit" name="submit">Submit</button>
        </form>
        <!-- This canva is for the animation background -->
